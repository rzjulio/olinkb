...
def bootstrap_workspace(
    *,
    ...
    settings_status = persist_settings_file(pg_url=pg_url, team=team, project=resolved_project)
    shell_env_status = persist_shell_env_file(pg_url=pg_url, team=team, project=resolved_project)
...
def _environment_document(pg_url: str, team: str, project: str | None = None) -> dict[str, str]:
    document = {
...
def persist_settings_file(*, pg_url: str, team: str, project: str | None = None) -> str:
    path = get_global_settings_path()
    document = _environment_document(pg_url, team, project)
...
def persist_shell_env_file(*, pg_url: str, team: str, project: str | None = None) -> str:
    path = get_global_shell_env_path()
    wrapper_dir = get_global_command_wrapper_path().parent
    exports = _environment_document(pg_url, team, project)
    lines = [
